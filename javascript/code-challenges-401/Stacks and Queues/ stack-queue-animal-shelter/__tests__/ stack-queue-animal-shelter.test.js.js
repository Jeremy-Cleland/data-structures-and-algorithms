...
const { Stack, Queue, AnimalShelter } = require('../index');
...
describe('Queue', () => {
  ...
  test('Can successfully add an an animal to the correct queue', () => {
    let shelter = new AnimalShelter();
    shelter.enqueue('Fido', 'dog');
    shelter.enqueue('Fifi', 'cat');
    shelter.enqueue('Fido', 'dog');

    expect(shelter.dogs.first.name).toEqual('Fido');
    expect(shelter.cats.first.name).toEqual('Fifi');
  });

  test('Can successfully dequeue an animal from the correct queue', () => {
    let shelter = new AnimalShelter();
    shelter.enqueue('Fido', 'dog');
    shelter.enqueue('Fifi', 'cat');
    shelter.enqueue('Fido', 'dog');
    ...
    expect(adoptedDog.name).toEqual('Fido');
    expect(shelter.dogs.first.name).toEqual('Fido');
  });
});
